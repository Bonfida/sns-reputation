...
import { getBestStakeAccountForVoter, parseStakeAndEpoch } from "../src/secondary_bindings";
...
test('test stake account retrieval', async () => {
    let accounts = await getBestStakeAccountForVoter(connection, new PublicKey("J6QDztZCegYTWnGUYtjqVS9d7AZoS43UbEQmMcdGeP5s"), 1000);
